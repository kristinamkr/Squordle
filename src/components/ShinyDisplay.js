...
import classes from "./style/ShinyDisplay.module.css";

function ShinyDisplay(props)
{
	return (
		<div className = {classes.ShinyDisplay}>
			<p/>
			<img style = {{width: "80%"}} 
			...
			<button onClick = {props.ShinyHandler}>
                Close
            </button>
			<p/>
		</div>
